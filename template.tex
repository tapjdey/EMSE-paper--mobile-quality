...
\begin{figure}[!t]
\centering
\includegraphics[width=0.7\linewidth]{qAGA}%
...
\begin{figure}[!t]
\centering
\includegraphics[width=0.7\linewidth]{qAD}%
...
As mentioned before, for the analysis of the NPM data
