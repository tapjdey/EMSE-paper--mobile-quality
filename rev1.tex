...
Objective: To determine how software faults and software use are
   related and how, based on that, an accurate, usage-independent quality 
...
Results: We found the number of new users to be 
  ...
  Release quality expressed as crashes per user was found to be independent of
...
The reason for experimenting with these broad set of methods and options is that we wanted to perform the simulation study on a broad range to techniques to identify the best performing heuristic method in this context (\emph{i.e.}, for the software failure data). 
